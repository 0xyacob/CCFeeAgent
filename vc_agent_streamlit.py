    ...
    with col_left:
        ...
        **Recipient Email:** {result.get('to_email', 'N/A')}  
        ...
        if result.get('email_content'):
            ...
            # Do not append share quantity notes to the letter content shown to investors.
            # Keep the email content exactly as generated by the template for professionalism.
